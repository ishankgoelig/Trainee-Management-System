								...
								<form method="post" enctype="multipart/form-data">		
									...
									<!--  name-->
										<div class="form-group">
											<label>Name</label>
											<input class="form-control" placeholder="Name of new trainee" name="na"value="<?php echo $data["name"];?>">
										</div>
									<!--  father name-->
										<div class="form-group">
									...
									<!--update or reset button  -->
										<div class="form-group">
											...
											<a href="resetedit_enquiry.php?edi=<?php echo $data['id'];?>">
...
if(isset($_POST['sub']))
{
	...
	if(in_array("$en",$format))
	{
			...
			$query="update tbl_enquiry set name='$a',father_name='$b',contact='$c',email='$d',address='$e',course='$f',gender='$g',doj='$h'
			...
			$row=mysql_query($query);
				if($row > 0)
				{
					...
					echo "<script> window.location.href='display_enquiry.php'</script>";
				}
				else
				{
