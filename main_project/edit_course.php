                ...
                <div class="row">
					...
					<div class="panel panel-info">
                            <div class="panel-heading">
                                <h2 class="panel-title">Present course detail &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp
								...
								<div style='margin-left:350px;'>
									...
									<!--  name-->
										<div class="form-group">
											...
											<input class="form-control" placeholder="Name of center " name="na" value="<?php echo $data["course_name"];?>">
										</div>
...
if($row > 0)
{
	...
	echo "<script> window.location.href='display_course.php'</script>";
}
else
{
