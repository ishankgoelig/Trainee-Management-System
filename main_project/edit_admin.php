								...
								<div style='margin-left:270px;'>
									...
									<!--  name-->
										<div class="form-group">
											<label>Name</label>
											<input class="form-control" placeholder="Name of admin " name="na"value="<?php echo $data["name"];?>">
										</div>
									...
									<!-- email -->
										<div class="form-group">
											...
											<input class="form-control" placeholder="Email-Id of Admin" type="email" name="em" value="<?php echo $data["email"];?>">
										</div>
									<!-- password -->
										<div class="form-group">
											<label>Password</label>
											<input class="form-control" placeholder="Password of Admin" type="password" name="pwd" value="<?php echo $data["password"];?>">
										</div>
